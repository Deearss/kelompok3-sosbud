    ...
    <li className="mb-1.5 list-none">
      ...
      >
        ...
        {children && (
          <ChevronRight
            size={18}
            className={cn("text-accent transition-transform duration-200", {
              "rotate-90": isOpen,
            })}
          />
        )}
      ...
      {children && (
        <div
          className={cn(
            "py-2 pl-4 max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0",
            {
      ...
      <Section>
        ...
        <Card className="text-[13.5px] text-textDim p-5!">
          ...
          <div className="mb-2">
            ...
            <strong className="text-textColor">Kata Pengantar</strong> — syukur,
            latar, terima kasih, harapan manfaat
          </div>
          <div>
            <Badge variant="muted" className="mr-2!">
              3
